...
const LoanCal = () => {
  const [loanAmount, setLoanAmount] = useState(); // Loan amount in dollars
  const [interestRate, setInterestRate] = useState(); // Annual interest rate
  const [loanTenure, setLoanTenure] = useState(); // Loan tenure in months
  ...
  return (
    <div className="min-h-screen flex items-center justify-center mt-6 bg-white p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-2xl overflow-hidden p-6">
        ...
        <button
          ...
          className="w-full bg-green-700 text-white p-2 rounded-lg font-semibold hover:bg-green-600 transition duration-200"
        >
          Calculate
        </button>
