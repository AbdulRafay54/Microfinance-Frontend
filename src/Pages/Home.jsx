...
const Home = () => {
  return (
    <div className="container mx-auto">
      <section className="container mx-auto pt-20 text-gray-600 body-font h-auto min-h-[85vh] flex flex-col-reverse md:flex-row items-center">
        <div className="w-full md:w-1/2 flex flex-col gap-5 mt-10 px-6 md:px-0">
